...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["neodev.nvim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/neodev.nvim",
  ...
  ["telescope-fzf-native.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/opt/telescope-fzf-native.nvim",
  ...
  ["vim-sleuth"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/vim-sleuth",
